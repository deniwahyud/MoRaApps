...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public User queryUser(String email, String password) {
        ...
        Cursor cursor = db.query(DatabaseOption.USERS_TABLE, new String[]{DatabaseOption.ID,
                        DatabaseOption.EMAIL, DatabaseOption.PASSWORD}, DatabaseOption.EMAIL + "=? and " + DatabaseOption.PASSWORD + "=?",
    ...
    public User queryUsers(String email) {
        ...
        Cursor cursor = db.query(DatabaseOption.USERS_TABLE, new String[]{DatabaseOption.ID,
                        DatabaseOption.EMAIL}, DatabaseOption.EMAIL + "=?",
